...
static exportPublicKeyContext_t *ctx             = &g_instructionContext.exportPublicKeyContext;
    ...
    if (p1 == 0x01) {
        ...
        if (keyPath->pathLength == 5 && keyPath->rawKeyDerivationPath[0] == 1105) {
            ...
            if (keyPath->rawKeyDerivationPath[0] == 44
                ...
                getIdentityAccountDisplay(
                    ctx->display, sizeof(ctx->display), identityIndex, accountIndex);
            }
        }
