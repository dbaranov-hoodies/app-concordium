...
{
    return ctx_conf_baker->hasTransactionFeeCommission || ctx_conf_baker->hasBakingRewardCommission
                              ...
                              bool                   isInitialCall)
{
    ...
    else if (P1_AGGREGATION_KEY == p1 && ctx_conf_baker->state == CONFIGURE_BAKER_AGGREGATION_KEY) {
