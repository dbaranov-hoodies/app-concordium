...
cx_bn_t *cx_bn_alloc(void)
{
    return (cx_bn_t *) 1;
}
cx_bn_t *cx_bn_alloc_init(void *src, size_t size)
{
    return (cx_bn_t *) 1;
}
...
int  cx_bn_cmp(cx_bn_t *a, cx_bn_t *b)
{
    return 0;
}

// ================= cx_ecpoint_* =================
cx_ecpoint_t *cx_ecpoint_alloc(void)
{
    return (cx_ecpoint_t *) 1;
}
...
// ================= Base58 / utils =================
uint32_t base58check_encode(const uint8_t *in, uint32_t len, char *out, uint32_t out_len)
{
    return 0;
}
